...
<template>
  <div class="print-container bg-white text-slate-800 w-[210mm] min-h-[297mm] print:w-full print:max-w-none print:min-h-0 mx-auto p-10 md:p-14 print:px-8 print:py-8 block text-[13px] md:text-[14px] leading-relaxed" :style="cssVars">
