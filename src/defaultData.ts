...
export const defaultData: CvData = {
    ...
    sectionSettings: {
        ...
        academic: {
            title: 'ACADEMIC CONTRIBUTIONS', visible: true,
            subsections: {
                society: { title: 'Societies and Associations', visible: true },
                reviews: { title: 'Research Services', visible: true },
                contributions: { title: 'Academic Contributions', visible: true },
                fundings: { title: 'Research Fundings', visible: true },
            },
        },
    ...
    societyServices: [
        {
            ...
            location: '',
            description: '',
            bullets: ['Member, Youth Committee of Sichuan Bioinformatics Society (2023 - present)'],
            bulletListType: 'unordered'
        }
    ],
    reviews: [
        {
            ...
            location: '',
            description: '',
            bullets: ['Peer Reviewer for Springer Journal: BJC Reports (2024), Journal of Gastrointestinal Cancer (2025)'],
            bulletListType: 'unordered'
        }
    ],
    contributions: [
